...
​Using your session `accessToken` as the authorization value in the request header, place an ‘order’ by calling: `POST https://prod.api.btdx.io/orders` 
...
​In order to maintain a robust Exchange product for all, the following general rate limits are enforced: 
...
_​Terms last updated 25th May 2026_
